	...
	<div class="box">
		...
		<div class="loginPage">
			...
			<el-form :model="loginForm" :rules="loginRules" ref="loginForm" status-icon>
			  ...
			  <el-form-item>
			    <el-button type="danger" @click="toLogin('loginForm')">登录</el-button>
			  </el-form-item>
			</el-form>
			<p class="tip">还没有账号？去<span @click="toRegister">注册</span></p>
		</div>
	</div>
</template>
<style scoped>
	...
	/*登录页面*/
	.loginPage{width:400px;top:200px;left:50%;margin-left:-200px; position:absolute;background-color: rgba(255,255,255,0.3);padding:20px;border-radius: 8px;}
	.loginPage .title{text-align: center;color:#fff;font-size: 26px;padding:20px;font-weight: 400;}
	.loginPage .el-form{width:100%;}
	.loginPage .el-button{width:100%;}
	.loginPage .tip{text-align: center;color:#fff;}
	.loginPage .tip span{cursor:pointer;color:#f56c6c;padding-left:3px;}
